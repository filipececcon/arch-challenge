...
namespace ArchChallenge.CashFlow.Infrastructure.Agents.Outbox.Configuration;
...
public static class OutboxServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddOutboxAgent(
        ...
        IConfiguration     configuration)
    {
        services
            ...
            .Configure(o =>
            {
                o.TypeMap[ExecuteTransactionOutboxMapper.EventNameValue] = typeof(TransactionRegisteredIntegrationEvent);
            })
            .ValidateOnStart();
