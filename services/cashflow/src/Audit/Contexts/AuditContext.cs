...
namespace ArchChallenge.CashFlow.Infrastructure.CrossCutting.Audit.Contexts;
...
public sealed class AuditContext : IAuditContext
{
    ...
    public bool TryBuildAuditOutboxPayload(out string eventName, out string payloadJson)
    {
        ...
        // Serializar pelo tipo em runtime — IAggregateRoot é interface vazia e geraria "state": {}.
        var stateElement = JsonSerializer.SerializeToElement(_aggregate, _aggregate.GetType(), JsonOptions);
